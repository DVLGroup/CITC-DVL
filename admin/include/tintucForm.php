					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="addEditDelete/editOneUser.php?tintucID=<?php echo($row['0']); ?>">Sửa</a> 
									&nbsp; 
									<a href="addEditDelete/deleteOneTinTuc.php?tintucID=<?php echo($row['0']); ?>&tintucTitle=<?php echo($row['1']); ?>">Xóa</a>
								</td>
							</tr>
							<?php
							}
